...
public class TrainerRunner {
    ...
    private static final List<String> models = Arrays.asList("acknowledgement", "affiliation", "chemical", "date", "citation", "ebook", "fulltext", "header", "name-citation", "name-header", "patent");
    ...
    public static void main(String[] args) {
        ...
        if (model.equals("affiliation") || model.equals("affiliation-address")) {
            ...
            trainer = new AcknowledgementTrainer();
        }
        else {

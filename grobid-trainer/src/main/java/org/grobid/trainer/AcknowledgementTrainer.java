...
import org.grobid.trainer.sax.TEIAcknowledgementSaxParser;
 ...
 */
public class AcknowledgementTrainer extends AbstractTrainer {

    public AcknowledgementTrainer() {
	...
	public int createCRFPPData(final File corpusDir, 
		...
		try {
			...
			for (; n < refFiles.length; n++) {
				...
				final TEIAcknowledgementSaxParser parser2 = new TEIAcknowledgementSaxParser();
                ...
                String headerAcknowledgment = FeaturesVectorAcknowledgement .addFeaturesAcknowledgment(labeled);
    ...
    public static void main(String[] args) throws Exception {
        ...
        AcknowledgementTrainer trainer = new AcknowledgementTrainer();
